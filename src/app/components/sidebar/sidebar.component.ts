...
@Component({
  ...
  template: `
    <aside [class.w-72]="!sidebarService.isCollapsed()" [class.w-20]="sidebarService.isCollapsed()" 
           ...
           class="hidden md:flex flex-col border-r border-[#2a3441] bg-[#0c0e12] h-screen sticky top-0 transition-all duration-300 ease-in-out z-30 shadow-2xl overflow-hidden group/sidebar">
      
      <!-- Logo Section -->
      <div class="p-6 border-b border-[#2a3441] relative overflow-hidden group min-h-[88px] flex items-center">
        ...
        <div class="flex items-center gap-3 relative z-10 w-full">
          ...
          <div class="flex flex-col whitespace-nowrap overflow-hidden transition-all duration-300" 
            ...
            <h1 class="font-black text-xl leading-none text-white tracking-widest uppercase">COMMANDER<span class="text-[#ec5b13]">CONSOLE</span></h1>
      ...
      <nav class="flex-1 px-0 py-6 space-y-2 overflow-y-auto overflow-x-hidden">
        ...
        <div class="flex items-center px-6 mb-2 transition-opacity duration-300" [class.opacity-0]="sidebarService.isCollapsed()">
            <span class="text-[9px] text-slate-500 font-bold uppercase tracking-widest border-l-2 border-slate-700 pl-2 whitespace-nowrap">Operations</span>
        </div>

        <a routerLink="/" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}" 
           class="flex items-center gap-4 px-6 py-3 border-l-2 transition-all group relative border-transparent hover:border-[#ec5b13] hover:bg-[#ec5b13]/5 text-slate-400 hover:text-white [&.active]:border-[#ec5b13] [&.active]:bg-[#ec5b13]/10 [&.active]:text-[#ec5b13]">
        ...
        <div class="flex items-center px-6 mt-6 mb-2 transition-opacity duration-300" [class.opacity-0]="sidebarService.isCollapsed()">
            <span class="text-[9px] text-slate-500 font-bold uppercase tracking-widest border-l-2 border-slate-700 pl-2 whitespace-nowrap">System_Control</span>
        </div>
      ...
      <!-- Profile Section -->
      <div class="p-4 border-t border-[#2a3441] bg-[#0c0e12]">
        <div class="tac-panel p-3 flex items-center gap-3 group cursor-pointer hover:border-[#ec5b13] transition-colors rounded-lg overflow-hidden">
            ...
            <div class="relative shrink-0">
                <img alt="User" class="w-10 h-10 border border-slate-600 grayscale group-hover:grayscale-0 transition-all rounded object-cover" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=100&h=100"/>
                <div class="absolute -bottom-1 -right-1 w-3 h-3 bg-black border border-[#ec5b13] flex items-center justify-center">
            ...
            <div class="min-w-0 transition-all duration-300" 
                 ...
                 [class.w-0]="sidebarService.isCollapsed()"
                 [class.translate-x-[-10px]]="sidebarService.isCollapsed()">
                <p class="text-[10px] font-black text-white truncate tracking-widest leading-tight">ALEX_SEC</p>
